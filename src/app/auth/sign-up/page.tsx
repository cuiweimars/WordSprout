    ...
    <div className="bg-white rounded-2xl border p-8 shadow-sm">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Start tracking your child&apos;s sight word journey
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-sprout-500 text-white font-medium py-2.5 rounded-full hover:bg-sprout-600 transition-colors disabled:opacity-50"
        >
      ...
      <p className="text-center text-sm text-gray-600 mt-4">
        ...
        <Link
          href="/auth/sign-in"
          className="text-sprout-600 font-medium hover:text-sprout-700"
        >
          Sign in
        </Link>
      </p>
